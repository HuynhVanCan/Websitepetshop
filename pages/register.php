...
// Include database connection and fetch province data
    ...
    <form class="create_admin_form" action="../includes/register.php" method="POST">
        ...
        <div style="display: flex; justify-content: space-between; width: 400px;">
            <div class="form_field">
                ...
                <select required id="
                wards" class="textfile" style="width: 195px;">
...
<?php 
// Kiểm tra xem đã có thông báo từ session hay chưa
if(isset($_SESSION['registration_success'])) {
    // Hiển thị thông báo và xóa biến session
