...
<div class="footer">
    ...
    <div class="footter_row">
        ...
        <ul>
            <li>
                CÔNG TY CỔ PHẦN THUƠNG MẠI & DỊCH VỤ HAPPY
            </li>
            <li>
                Nguyễn Hữu Cảnh, Phường 25, Quận Bình Thạnh
            </li>
            <li>
                <i class="fa-solid fa-phone"></i> Hotline: 0392216028
            </li>
            <li>
                <i class="fa-solid fa-envelope"></i> Email: hvcan.contact@gmail.com
            </li>
        </ul>
    </div>
</div>
