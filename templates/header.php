...
<div class="app">
    ...
    <div class="gird">
        ...
        <div class="header" style="background-color: yellowgreen;">
            <div class="header_row1">
                <div class="header_row1_left">
                    <div class="logo">
                        <a href="<?php echo $rootPath ?>">
                            <img src="<?php echo $rootPath . "/assets/img/logo/logopaddy.png"; ?>" alt=""  style="margin: auto; height: 100px;">
                        </a>
                    </div>
                </div>
                <div class="header_row_right">
                    ...
                    <div class="hotline">
                        ...
                        <h5 class="hotline_sdt" style="font-weight: 600;">0392216028</h5>
                    </div>
                    <!-- <div class="h">
                        <div class="name_icon">
